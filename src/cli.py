...
from glitter_project import (
    create_new_project_from_remote_url,
    delete_project_and_remove_config,
    list_created_projects,
    add_and_update_files,
...
def list_projects():
    ...
    if not (current_project is None and projects is None):
